<template>
  <nav
    class="hidden md:flex lg:flex xl:flex items-center justify-between flex-wrap container mx-auto py-3 z-20 dark:text-gray-400"
  >
    <div class="flex-grow flex items-center w-auto mx-4">
      <div class="flex-grow">
        <ul class="list-none flex justify-left">
          <div class="flex">
            <Logo height="48" width="48" class="mr-2 mt-2" />
            <span
              class="w-12 mt-2 leading-tight uppercase text-xs text-white tracking-tight"
