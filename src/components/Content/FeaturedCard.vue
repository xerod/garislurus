<template>
  <div class="w-full lg:w-2/3 px-1 my-1 items-stretch">
    <div
      class="featured-post-card bg-gray-200 hover:shadow-md z-100 h-half-screen lg:h-full"
    >
      <VueSlickCarousel :arrows="true" :dots="false" class="h-full">
        <div
